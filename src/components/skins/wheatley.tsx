                    ...
                    <group ref={ref_platformStand}>
                        ...
                        <group ref={ref_platform}>
                            ...
                            <group ref={ref_platform_ballJoint_left}>
                                <mesh position={[0, 0, 0]} scale={[0.15, 0.15, 0.15]} rotation={[-Math.PI, 0, 0]} material={materialBallJoint}>
                                    <primitive object={geomBallJoint} />
                                </mesh>
    ...
    return (
        <Suspense fallback={null}>
            <primitive object={mech}>
                <primitive object={mech.base}>
                    <mesh rotation={[-Math.PI / 2, 0, 0]} material={materialBase}>
                        <primitive object={geomBase} />
                    </mesh>
                </primitive>
                <primitive object={mech.platformStand}>
                    <mesh rotation={[-Math.PI / 2, 0, 0]} material={materialBase}>
                        <primitive object={geomYawRod} />
                    </mesh>
                    <mesh rotation={[-Math.PI / 2, 0, 0]} material={materialBase}>
                    ...
                    <primitive object={mech.platformStand.ballJoint}>
                        <mesh position={[0, 0, 0]} scale={[0.15, 0.15, 0.15]} rotation={[-Math.PI, 0, 0]} material={materialBallJoint}>
                            <primitive object={geomBallJoint} />
                        </mesh>
                    </primitive>
                ...
                <primitive object={mech.platform}>
                    <mesh rotation={[-Math.PI / 2, 0, 0]} material={materialBase}>
                        <primitive object={geomCenterPlatform} />
                    </mesh>
                    {[
                        mech.platform.ballJoint_left,
                        mech.platform.ballJoint_right
                    ].map(bJoint => {
                        return (
                            <primitive object={bJoint} key={bJoint.uuid}>
                                <mesh position={[0, 0, 0]} scale={[0.15, 0.15, 0.15]} rotation={[-Math.PI, 0, 0]} material={materialBallJoint}>
                                    <primitive object={geomBallJoint} />
                                </mesh>
                                <axesHelper args={[5]}></axesHelper>
                    ...
                    <axesHelper args={[30]}></axesHelper>
                </primitive>
                {[
                    mech.servo_PitchRoll_left,
                    mech.servo_PitchRoll_right,
                    mech.servo_Yaw
                ].map(servo => {
                    return (
                        <primitive object={servo} key={servo.uuid}>
                            <mesh material={materialServo}>
                                <primitive object={geomServo} />
                            </mesh>
                            <primitive object={servo.horn}>
                                <mesh rotation={[Math.PI, 0, 0]} material={materialServoHorn}>
                                    <primitive object={geomServoHorn} />
                                </mesh>
                                <primitive object={servo.horn.ballJoint}>
                                    <mesh position={[0, 0, 0]} scale={[0.15, 0.15, 0.15]} rotation={[-Math.PI, 0, 0]} material={materialBallJoint}>
                                        <primitive object={geomBallJoint} />
                                    </mesh>
                                    <axesHelper args={[5]}></axesHelper>
